...
def main() -> int:
    ...
    commands = {
        "ingest": orchestrator.run_ingest,
        "normalize": orchestrator.run_normalize,
        "ner": orchestrator.run_ner,
        "relation": orchestrator.run_relation,
        "build": orchestrator.run_build_and_store,
        "export": orchestrator.run_export,
        "validate": orchestrator.run_validate,
    }
